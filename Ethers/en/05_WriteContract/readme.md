...
`WETH` (Wrapped ETH) is a wrapped version of `ETH`. It wraps native Ethereum tokens using a smart contract to conform to the `ERC20` standard. For more detailed content about the `WETH` contract, refer to the [Solidity Tutorial on WETH](https://www.wtf.academy/solidity-application/WETH/).
