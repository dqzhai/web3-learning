...
# Ethers: 10. BigInt and Unit Conversion
...
Note: This tutorial is based on ethers.js v6. If you are using v5, you can refer to the [Ethers v5](https://github.com/WTFAcademy/WTF-Ethers/tree/wtf-ethers-v5).
