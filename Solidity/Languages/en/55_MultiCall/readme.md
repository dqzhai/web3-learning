...
# Minimalist introduction to Solidity: 55. Multiple calls

I'm recently re-learning solidity, consolidating the details, and writing a "Solidity Minimalist Introduction" for novices (programming experts can find another tutorial), updating 1-3 lectures every week.
...
If you don’t understand `calldata`, you can read Solidity [Lecture 29].
