...
# Solidity Beginner's Guide: 36. Merkle Tree

Recently, I have been reviewing solidity in order to consolidate some details and write a "Solidity Beginner's Guide" for novices (programming experts can find other tutorials). I will update 1-3 lessons weekly.

Welcome to follow me on Twitter: [@0xAA_Science](https://twitter.com/0xAA_Science)

Welcome to the Scientist community, which includes methods for adding WeChat groups: [link](https://discord.gg/5akcruXrsk)
