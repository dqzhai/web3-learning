...
# Solidity Beginner's Guide: 35. Dutch Auction
...
The `constructor` function initializes a new `ERC721` token with the name "Dutch Auction" and the symbol "Dutch Auction". It sets the `auctionStartTime` to the current block timestamp.
