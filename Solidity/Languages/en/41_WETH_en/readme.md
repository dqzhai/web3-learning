...
# Solidity Crash Course: 41. WETH

I am currently re-learning Solidity to refresh my knowledge and create a "Solidity Crash Course" for beginners to use (advanced programmers may find other resources more suitable). A new lesson will be added each week.
