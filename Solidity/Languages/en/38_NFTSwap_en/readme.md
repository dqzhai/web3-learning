...
# Simplified Introduction to Solidity: 38. NFT Exchange

I have been revisiting Solidity lately to review the details and create a "Simplified Introduction to Solidity" for beginners (professional programmers may find other tutorials more suitable), with 1-3 updates per week.
