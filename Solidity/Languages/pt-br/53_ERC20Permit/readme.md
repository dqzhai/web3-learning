...
Eu recentemente tenho revisitado o solidity para consolidar alguns detalhes e escrever um "Solidity - Introdução Simples" para iniciantes (programadores mais avançados podem buscar outros tutoriais), com atualizações semanais de 1 a 3 aulas.
