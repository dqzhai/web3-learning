...
Eu recentemente revisitei o Solidity para consolidar os detalhes e estou escrevendo um "Introdução super simplificada ao Solidity" para iniciantes (os mestres da programação podem encontrar outros tutoriais), atualizado semanalmente com 1-3 palestras.
