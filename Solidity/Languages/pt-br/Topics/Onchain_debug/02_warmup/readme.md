...
- Primeiro, você precisa instalar o [Foundry](https://github.com/foundry-rs/foundry) no ambiente. Consulte as [instruções](https://book.getfoundry.sh/getting-started/installation.html) para saber como instalar.
    - O teste principal será feito com o [Forge test](https://book.getfoundry.sh/reference/forge/forge-test). Se você estiver usando o Foundry pela primeira vez, consulte o [Foundry book](https://book.getfoundry.sh/), [Foundry @EthCC](https://www.youtube.com/watch?v=wJnywGB33O4) e [Solidity - Foundry](https://github.com/AmazingAng/WTF-Solidity/blob/main/Topics/Tools/TOOL07_Foundry/readme.md)
