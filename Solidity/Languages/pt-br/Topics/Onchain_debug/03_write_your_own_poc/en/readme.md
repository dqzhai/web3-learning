...
* No Ethereum EVM, você verá 3 tipos de chamadas para acionar funções remotas:
  ...
  3. DelegateCall: `msg.sender` permanecerá o mesmo, geralmente usado para chamadas de proxy. Consulte [Solidity](https://github.com/WTFAcademy/WTF-Solidity/tree/main/23_Delegatecall) para mais detalhes.
