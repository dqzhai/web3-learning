...
Optamos por usar o Foundry para reproduzir o ataque de manipulação do oráculo, pois é rápido e permite criar forks locais da mainnet para facilitar os testes. Se você não está familiarizado com o Foundry, pode ler [Solidity Ferramentas T07: Foundry](../Topics/Tools/TOOL07_Foundry/readme_pt-br.md).
