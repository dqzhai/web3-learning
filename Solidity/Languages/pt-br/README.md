...
# Solidity
Eu recentemente comecei a reestudar Solidity para reforçar os detalhes e também escrever um "Solidity Guia Básico" para iniciantes (programadores experientes podem procurar outros tutoriais), com atualizações semanais de 1-3 aulas.
