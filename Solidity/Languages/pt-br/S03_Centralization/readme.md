...
Recentemente, tenho estudado Solidity novamente para consolidar os detalhes e escrever um "Solidity Guia Rápido" para iniciantes (os especialistas em programação podem procurar outros tutoriais), atualizando de 1 a 3 lições por semana.
