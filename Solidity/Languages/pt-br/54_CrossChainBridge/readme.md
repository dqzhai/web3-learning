...
# Solidity Introdução Simples: 54. Ponte de Cadeia Cruzada

Recentemente, tenho estudado solidity novamente para revisar os detalhes e escrever um "Solidity Introdução Simples" para iniciantes (programadores experientes podem procurar outros tutoriais). Serão lançadas de 1 a 3 aulas por semana.
