...
# Solidity 超シンプル入門: 16. 関数のオーバーロード
...
最終的に、オーバーロード関数はコンパイラによって異なる関数セレクタ（selector）に変換されます。関数セレクタについての詳細は[Solidity 超シンプル入門: 29. 関数セレクタ Selector](https://github.com/AmazingAng/WTF-Solidity/tree/main/29_Selector)を参照してほしいです。
